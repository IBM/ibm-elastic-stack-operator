...
IMG ?= ibm-cs-elastic-stack-operator
...
IMAGE_NAME=$(IMG)
IMAGE_DISPLAY_NAME=IBM CloudPak Logging Operator
IMAGE_MAINTAINER=hxiao@us.ibm.com
IMAGE_VENDOR=IBM
IMAGE_VERSION=$(VERSION)
IMAGE_DESCRIPTION=Operator that installs and manages Elastic Stack instances
IMAGE_SUMMARY=$(IMAGE_DESCRIPTION)
IMAGE_OPENSHIFT_TAGS=elastic-stack
